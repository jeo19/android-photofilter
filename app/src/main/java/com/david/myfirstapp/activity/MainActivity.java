...
import com.david.myfirstapp.fragment.EditImageFragment;
import com.david.myfirstapp.fragment.FiltersListFragment;
...
public class MainActivity extends AppCompatActivity implements FiltersListFragment.FiltersListFragmentListener, EditImageFragment.EditImageFragmentListener {
    ...
    private void loadImage() {
        originalImage = BitmapUtils.getBitmapFromAsserts(this, IMAGE_NAME, 300, 300);
        filteredImage = originalImage.copy(Bitmap.Config.ARGB_8888, true);
