...
**Attention**: This source code updated to AndroidX Library from deprecated some Android SDK 

> Tip: You should use the butterknife library which updated to version 10.2.1 and as see below code make sure to specify java version in build.gradle
...
Above code snippet will give you outputImage with increased brightness and contrast.
